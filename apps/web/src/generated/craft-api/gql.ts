 ...
 */
type Documents = {
    "\n    query GetEntries {\n      entries {\n        id\n        title\n        slug\n        postDate\n        sectionId\n      }\n    }\n  ": typeof types.GetEntriesDocument,
 ...
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "query Destinations {\n  destinationsEntries {\n    ... on destination_Entry {\n      id\n      title\n      slug\n    }\n  }\n}"): (typeof documents)["query Destinations {\n  destinationsEntries {\n    ... on destination_Entry {\n      id\n      title\n      slug\n    }\n  }\n}"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "fragment CTAEntry on cta_Entry {\n  uid\n  typeHandle\n  image {\n    ...CTAImageDetails\n  }\n  title\n  text\n  ctaLink {\n    url\n    label\n  }\n}\n\nfragment ArticlesSectionEntry on articlesSection_Entry {\n  uid\n  typeHandle\n  tagline\n  title\n  text\n  articlesType\n}\n\nfragment HighlightTextSectionEntry on highlightTextSection_Entry {\n  uid\n  typeHandle\n  tagline\n  title\n}\n\nfragment ImageWithTextEntry on imageWithText_Entry {\n  uid\n  typeHandle\n  image {\n    uid\n    alt\n    height\n    width\n    mimetype: mimeType\n  }\n  imageSide\n  fullWidthImage\n  showTagline\n  tagline\n  showTitle\n  fTitle\n  titleHeadingLevel\n  showText\n  text\n  showLink\n  fLink {\n    label\n    link\n  }\n  showItems\n  itemsStyle\n  items {\n    ... on items_Entry {\n      showTitle\n      title\n      fTitle\n      text\n    }\n  }\n}\n\nfragment StepsSectionEntry on stepsSection_Entry {\n  uid\n  typeHandle\n  tagline\n  title\n  showText\n  text\n  steps {\n    ... on step_Entry {\n      uid\n      image {\n        uid\n        alt\n        height\n        width\n        mimetype: mimeType\n      }\n      tagline\n      title\n      text\n    }\n  }\n}"): (typeof documents)["fragment CTAEntry on cta_Entry {\n  uid\n  typeHandle\n  image {\n    ...CTAImageDetails\n  }\n  title\n  text\n  ctaLink {\n    url\n    label\n  }\n}\n\nfragment ArticlesSectionEntry on articlesSection_Entry {\n  uid\n  typeHandle\n  tagline\n  title\n  text\n  articlesType\n}\n\nfragment HighlightTextSectionEntry on highlightTextSection_Entry {\n  uid\n  typeHandle\n  tagline\n  title\n}\n\nfragment ImageWithTextEntry on imageWithText_Entry {\n  uid\n  typeHandle\n  image {\n    uid\n    alt\n    height\n    width\n    mimetype: mimeType\n  }\n  imageSide\n  fullWidthImage\n  showTagline\n  tagline\n  showTitle\n  fTitle\n  titleHeadingLevel\n  showText\n  text\n  showLink\n  fLink {\n    label\n    link\n  }\n  showItems\n  itemsStyle\n  items {\n    ... on items_Entry {\n      showTitle\n      title\n      fTitle\n      text\n    }\n  }\n}\n\nfragment StepsSectionEntry on stepsSection_Entry {\n  uid\n  typeHandle\n  tagline\n  title\n  showText\n  text\n  steps {\n    ... on step_Entry {\n      uid\n      image {\n        uid\n        alt\n        height\n        width\n        mimetype: mimeType\n      }\n      tagline\n      title\n      text\n    }\n  }\n}"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "fragment CTAImageDetails on images_Asset {\n  uid\n  src: url @transform(width: 3840, height: 2438)\n  alt\n  height\n  width\n  mimetype: mimeType\n}"): (typeof documents)["fragment CTAImageDetails on images_Asset {\n  uid\n  src: url @transform(width: 3840, height: 2438)\n  alt\n  height\n  width\n  mimetype: mimeType\n}"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "query getPagesQuery {\n  pagesEntries {\n    ... on page_Entry {\n      uid\n      typeHandle\n      contentBuilder {\n        __typename\n        ...CTAEntry\n        ...ArticlesSectionEntry\n        ...HighlightTextSectionEntry\n        ...ImageWithTextEntry\n        ...StepsSectionEntry\n      }\n    }\n  }\n}"): (typeof documents)["query getPagesQuery {\n  pagesEntries {\n    ... on page_Entry {\n      uid\n      typeHandle\n      contentBuilder {\n        __typename\n        ...CTAEntry\n        ...ArticlesSectionEntry\n        ...HighlightTextSectionEntry\n        ...ImageWithTextEntry\n        ...StepsSectionEntry\n      }\n    }\n  }\n}"];
